...
|---|---|---|
| Unit tests ≥ 60 pass | 74 passing, 0 failing | `python3 tests/harness.py --unit` |
...
| Perf < 6 ms/frame | `ms_per_frame` 0.071 (`ms_step` 0.006, `ms_render` 0.066) | `python3 tests/harness.py --perf 300` |
